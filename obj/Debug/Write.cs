...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8CA95F116BB3300")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class Write : OpenSpan.Automation.Automator
{
	
	private OpenSpan.Automation.ConnectableMethod connectableMethod1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8CA95F116BB3300\\EntryPoint-8CA95F130F7735A")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8CA95F116BB3300\\HiddenTypeProxy-8CA95F132728940")]
	...
	public Write()
	{
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(Write));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8CA95F116BB3300");
		// 
		// Set component Ids
		// 
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8CA95F12C3521B4"));
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8CA95F130F7735A"));
		this.SetId(this.hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8CA95F132728940"));
		// 
		// Write
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_Write_1_");
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_Write_2_");
		...
		// connectableMethod1
		// 
		this.connectableMethod1.DisplayName = "<WriteAllText>";
		...
		memberprototype1.MemberName = "WriteAllText";
		...
		parameterprototype2.DefaultValue = "Openspan Rocks!";
		...
		// hiddenTypeProxy1
		// 
		this.hiddenTypeProxy1.AliasName = "Path";
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_Write_3_");
		...
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_Write_4_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_Write_5_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8CA95F116BB3300\\EntryPoint-8CA95F130F7735A");
		...
		// 
		this.CodeDomData = _resources_.GetString("_Write_6_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8CA95F12C3521B4"));
		connectableMethod1.DisplayName = "<WriteAllText>";
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8CA95F130F7735A"));
		...
		// hiddenTypeProxy1
		// 
		hiddenTypeProxy1.AliasName = "Path";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		// Set designComp Ids
		// 
		this.SetId(hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8CA95F132728940"));
		// 
		// Add components
		// 

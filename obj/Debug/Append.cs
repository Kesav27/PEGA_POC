...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8CA95F1C3E6BFF4")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class Append : OpenSpan.Automation.Automator
{
	
	private OpenSpan.Automation.ConnectableMethod connectableMethod2;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8CA95F1C3E6BFF4\\EntryPoint-8CA95F1D6B20968")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8CA95F1C3E6BFF4\\HiddenTypeProxy-8CA95F1D85809A2")]
	...
	public Append()
	{
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(Append));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8CA95F1C3E6BFF4");
		// 
		// Set component Ids
		// 
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8CA95F1D22B528C"));
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8CA95F1D6B20968"));
		this.SetId(this.hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8CA95F1D85809A2"));
		// 
		// Append
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_Append_1_");
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_Append_2_");
		...
		// connectableMethod2
		// 
		this.connectableMethod2.DisplayName = "<AppendAllText>";
		...
		parameterprototype2.DefaultValue = "I\'m appending";
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_Append_3_");
		...
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_Append_4_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_Append_5_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8CA95F1C3E6BFF4\\EntryPoint-8CA95F1D6B20968");
		...
		// 
		this.CodeDomData = _resources_.GetString("_Append_6_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8CA95F1D22B528C"));
		connectableMethod2.DisplayName = "<AppendAllText>";
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8CA95F1D6B20968"));
		...
		// Set designComp Ids
		// 
		this.SetId(hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8CA95F1D85809A2"));
		// 
		// Add components
		// 
